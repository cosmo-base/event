...
import { Telescope, Satellite, Rocket, Building, ArrowRight, CheckCircle, } from "lucide-react"
      ...
      <main className="relative min-h-screen overflow-x-hidden">
        ...
        <section className="relative py-24 md:py-32">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-[#EEEEFF] mb-8">
              宇宙をもっと身近に
            </h2>
            <p className="text-lg leading-relaxed text-[#EEEEFF]/70 mb-12 text-pretty">
              宇宙は遠い世界ではありません。
              <br />
              この診断では、あなたの興味や思考から
              <br />
              ...
              {["YES / NOで答えるだけ", "30秒で結果", "SNSでシェア可能"].map(
                (item) => (
                  ...
                  >
                    ...
                    <span className="text-sm text-[#EEEEFF]">{item}</span>
                  </div>
                )
              )}
            </div>
        ...
        <section className="relative py-24 md:py-32">
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-[#EEEEFF] mb-4">
                4つの宇宙タイプ
              </h2>
              <p className="text-[#EEEEFF]/70 text-pretty max-w-xl mx-auto">
                  ...
                  >
                    <div className="flex items-start gap-4 mb-4">
                      <div
                        ...
                        style={{ background: `${type.accent}15` }}
                      >
                      ...
                      <div>
                        ...
                        <h3 className="text-xl font-bold text-[#EEEEFF]">
                          {type.title} タイプ
                        </h3>
                      </div>
                    </div>
                    ...
                    <div className="text-sm text-[#EEEEFF]/60 pl-4 mb-4 leading-relaxed">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {type.activities.map((activity) => (
                        <span
                          ...
                          style={{ background: `${type.accent}10`, color: type.accent }}
                        >
                          {activity}
                        </span>
                      ))}
              ...
              {steps.map((item, index) => (
                <div key={item.step} className="w-full flex flex-col items-center">
                  <div className="glass w-full rounded-2xl p-6 flex items-center gap-6 relative z-10 border border-[#EEEEFF]/30">
                    ...
                    <div>
                      <p className="text-xs text-cyan-400 font-semibold tracking-wider uppercase mb-0.5">
                        {item.step}
                      </p>
                      <p className="text-sm md:text-base text-[#EEEEFF] font-medium">
                        {item.text}
                      </p>
                    </div>
                  </div>
                  ...
                  {index < steps.length - 1 && (
                    <div className="text-cyan-400 opacity-80 relative z-0 -my-2">
                      <svg width="60" height="60" viewBox="0 0 24 24" fill="currentColor" className="drop-shadow-[0_0_8px_rgba(0,242,254,0.4)]">
        ...
        <section className="relative py-24 md:py-16">
          ...
          />
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl md:text-5xl font-bold text-[#EEEEFF] mb-4">
              今すぐ宇宙タイプを診断する
            </h2>
