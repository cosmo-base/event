...
export const SDF26Data: EventSpecificData = {
  site: {
    pageTitle: "SDF26｜Cosmo Base イベント特設ページ",
    pageDescription:
  ...
  communityCta: {
    ...
    secondaryLinks: [
      ...
      { label: "宇宙タイプ診断を試す", href: "/event/SDF26/type", event: "click_space_type_diagnosis" },
