...
export const MCZ26Data: EventSpecificData = {
  ...
  event: {
    name: "MIRAI CREATOR'Z FES 2026",
    shortName: "MIRAI CREATOR'Z FES",
    date: "2026年9月14日（月）",
    venue: "ベルサール半蔵門",
    boothNumber: "14",
    pitchTime: "",
  ...
  quickLinks: [
    {
      id: "ql-event-hp",
      title: "イベント公式サイト",
      description: "MIRAI CREATOR'Z FES 2026",
      href: "https://mirai-creatorz.com/event",
      icon: "building",
      external: true,
    ...
    },
    {
      id: "ql-venue",
      title: "会場サイト",
      description: "ベルサール半蔵門",
      href: "https://www.bellesalle.co.jp/shisetsu/tokyo/bs_hanzomon/",
      icon: "building",
      external: true,
