...
import { SDF26Data } from "@/data/events/SDF26"
...
export default function Page() {
  const data = { ...orgData, ...SDF26Data }

  return (
    <div className="min-h-dvh bg-background">
      <PageViewTracker eventId="SDF26" />
      <a
        href="#main"
      ...
      <main id="main">
        ...
        <LimitedContentSection items={data.limitedContents} eventId="SDF26" />
        ...
        <section aria-labelledby="survey-heading" className="py-12">
          <div className="mx-auto max-w-2xl px-4">
            ...
            <EventSurvey eventId="SDF26" eventName={data.event.shortName} questions={SURVEY_QUESTIONS} />
          </div>
        </section>
